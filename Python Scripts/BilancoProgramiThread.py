...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_17.setGeometry(QtCore.QRect(1500, 230, 231, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_18.setGeometry(QtCore.QRect(1560, 260, 121, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.label_18.setFont(font)
        self.label_18.setObjectName("label_18")
        self.excelSayfa = QtWidgets.QListWidget(self.centralwidget)
        self.excelSayfa.setGeometry(QtCore.QRect(1500, 300, 231, 271))
        self.excelSayfa.setObjectName("excelSayfa")
        self.sayfaExcel = QtWidgets.QPushButton(self.centralwidget)
        self.sayfaExcel.setGeometry(QtCore.QRect(1500, 590, 231, 61))
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.sayfaExcel.setFont(font)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("icons/sheets.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.sayfaExcel.setIcon(icon13)
        self.sayfaExcel.setIconSize(QtCore.QSize(50, 50))
        self.sayfaExcel.setObjectName("sayfaExcel")
        self.label.raise_()
        ...
        self.excelSayfa.raise_()
        self.sayfaExcel.raise_()
        
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1744, 26))
        ...
        self.sayfaExcel.clicked.connect(self.excelSayfa.doItemsLayout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_3.setText(_translate("MainWindow", "2020"))
        ...
        self.label_17.setText(_translate("MainWindow", "Excel Tablosunda Olmayacak"))
        self.label_18.setText(_translate("MainWindow", "Sayfa İsimleri"))
        self.sayfaExcel.setText(_translate("MainWindow", "Excel Sayfalarını Çek"))
...
class Bilanco(QMainWindow):
    def __init__(self):
        ...
        self.programmer = RunThread(self.ui)
        ...
        self.ui.excelSayfa.setSelectionMode(
            QAbstractItemView.ExtendedSelection
        )
        self.ui.excelSayfa.setEditTriggers(QAbstractItemView.DoubleClicked|QAbstractItemView.EditKeyPressed)
        self.ui.excelSayfa.setSelectionMode(QAbstractItemView.MultiSelection)
        self.ui.excelSayfa.setViewMode(QListView.ListMode)
        ...
        self.ui.sayfaExcel.clicked.connect(self.excelSheetCek)
    ...
    def excelYedekle(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.ui.bildirim.setText("Bilanco excel'i yedeklendi!") 
        self.programmer.which = "excelYedekle"
        self.programmer.start()
        
    def donemselTum(self): 
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "donemselTum"
        self.programmer.start()
        
    def sirketlerKap(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "sirketlerKap"
        self.programmer.start()
...
#        print(items1)
    ...
    def excelSheetCek(self):
        self.ui.excelSayfa.clear()
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "excelSheetCek"
        self.programmer.start()
                    
    def cekSecilen(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "cekSecilen"
        self.programmer.start()
    ...
    def bilancoExcel(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "bilancoExcel"
        self.programmer.start()
        
    def zipeAktar(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "zipeAktar"
        self.programmer.start()
    ...
    def hepsiExcel(self):
        ...
        items1 = [item.text() for item in self.ui.excelSayfa.selectedItems()]
        
        print(items1)
            
        for sheet in items1:
            excel_list.remove(sheet)
...
#        print(sonExcel)
    ...
    def listeyeDok(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "listeyeDok"
        self.programmer.start()
     
    def widgetListele(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "widgetListele"
        self.programmer.start()
        
    def genelYukle(self):
        self.ui.statusbar.showMessage("Working...")
        self.programmer.isStop = False
        self.programmer.which = "genelYukle"
        self.programmer.start()
    ...
    def devamEttir(self):
            self.ui.statusbar.showMessage("Working...")
            self.programmer.isStop = False
            self.programmer.which = "devamEttir"
            self.programmer.start()        
...
class RunThread(QThread):
    ...
    def selectedDownload(self):
        ...
        self.ui.bildirim.setText("Seçilen sirketler basariyla indirildi!")
        self.ui.statusbar.showMessage("Done")
        self.isStop = True  
        
        
    def balanceExcel(self):
        sheets = pd.read_excel('Bilanco-Excel/Bilanco.xlsm' ,sheet_name=['KOZAA'])
        ...
        self.ui.bildirim.setText("Bilanco excel'i iceri alindi!")
        self.ui.statusbar.showMessage("Done")
        self.isStop = True    
        
        
    def toZip(self):
        self.ui.bildirim.setText("Zip dosyalari açılıyor!")
        ...
        if(donem == 5):
            donemStr = "Tum Donemler.zip"
        elif(donem == 4):
            donemStr = "Yillik.zip"
        elif(donem == 3):
            donemStr = "9 Aylik.zip"
        elif(donem == 2):
            donemStr = "6 Aylik.zip"
        else:
            donemStr = "3 Aylik.zip"
        
        yilDonem = str(yil) + "-" + donemStr
        print(yilDonem)
    ...
    def listToWidget(self):
        ...
        self.ui.bildirim.setText("Sirketler listelendi!")
        self.ui.statusbar.showMessage("Done")
        self.isStop = True
    ...
    def generalDownload(self):
        ...
        self.ui.bildirim.setText("Secinler sirketler basariyla indirildi!")
        self.ui.statusbar.showMessage("Done")
        self.isStop = True        
    ...
    def getExcelSheets(self):
        ...
        self.ui.excelSayfa.addItems(excel_list)
        self.ui.bildirim.setText("Tabloda olmayacak excel sayfaları seçilmeye hazır!")
        self.ui.statusbar.showMessage("Done")
        self.isStop = True
    ...
    def run(self):
        if self.which == "excelYedekle":
            while not self.isStop:
                self.backedUpExcel()
        elif self.which == "donemselTum":
            while not self.isStop:
                self.allPeriodic()
        elif self.which == "sirketlerKap":
            while not self.isStop:
                self.companiesKap()
        elif self.which == "cekSecilen":
            while not self.isStop:
                self.selectedDownload()
        elif self.which == "bilancoExcel":
            while not self.isStop:
                self.balanceExcel()
        elif self.which == "zipeAktar":
            while not self.isStop:
                self.toZip()
        elif self.which == "listeyeDok":
            while not self.isStop:
                self.toList()
        elif self.which == "widgetListele":
            while not self.isStop:
                self.listToWidget()
        elif self.which == "genelYukle":
            while not self.isStop:
                self.generalDownload()
        elif self.which == "devamEttir":
            while not self.isStop:
                self.continueDownload()
        elif self.which == "excelSheetCek":
            while not self.isStop:
                self.getExcelSheets()
